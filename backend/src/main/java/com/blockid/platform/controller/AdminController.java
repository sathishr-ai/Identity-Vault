...
public class AdminController {
    ...
    public ResponseEntity<?> getDashboardStats() {
        ...
        long totalVerified = userRepository.countByStatus("verified");
        long pendingVerification = userRepository.countByStatus("pending");
        long rejectedRequests = userRepository.countByStatus("rejected");
    ...
    public ResponseEntity<?> approveIdentity(@PathVariable("userId") Long userId) {
        try {
            ...
            vHistory.setCheckedFields("National ID, Passport");
    ...
    public ResponseEntity<?> getMonthlyAnalytics() {
        ...
        for (int i = 6; i >= 0; i--) {
            ...
            for (User u : users) {
                ...
                if (u.getJoinDate() != null && u.getJoinDate().getMonthValue() == monthDate.getMonthValue()
